...
import TitleBar from '@/components/default/bar/TitleBar'
import HeroBar from '@/components/default/bar/HeroBar'
import ProfileUpdateForm from '@/components/default/form/ProfileUpdateForm'
import PasswordUpdateForm from '@/components/default/form/PasswordUpdateForm'
import Tiles from '@/components/default/Tiles'
import UserAvatar from '@/components/default/UserAvatar'
export default {
  name: 'Profile',
  components: {
    UserAvatar,
